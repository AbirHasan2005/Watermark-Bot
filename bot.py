...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/doreamonfans3"), InlineKeyboardButton("Support Group", url="https://t.me/disneyteamchat")], [InlineKeyboardButton("updates Channel", url="https://t.me/disneygrou")], [InlineKeyboardButton("Source Code", url="https://github.com/disneyteam75/Watermark-Bot")]]),
...
async def button(bot, cmd: CallbackQuery):
	...
	if "refreshmeh" in cb_data:
		...
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/doreamonfans3"), InlineKeyboardButton("Support Group", url="https://t.me/disneyteamchat")], [InlineKeyboardButton("updates Channel", url="https://t.me/disneygrou")]]),
			disable_web_page_preview=True
		)
