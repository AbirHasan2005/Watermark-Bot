...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("👨‍💻Developer👨‍💻", url="https://t.me/doreamonfans1"), InlineKeyboardButton("🤖Support Group🤖", url="https://t.me/disneyteamchat")], [InlineKeyboardButton("👨‍🔧updates Channel👨‍🔧", url="https://t.me/disneygrou")], [InlineKeyboardButton("👨‍💻👨‍💻developer2👨‍💻👨‍💻", url="https://t.me/doreamonfans2")]]),
